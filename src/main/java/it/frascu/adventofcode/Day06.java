...
public class Day06 {
    ...
    public static void main(String[] args) {
        try (Scanner scanner = new Scanner(Day06.class.getClassLoader().getResourceAsStream("Day06.txt"))) {
            ...
            System.out.println("Part 1: " + getNumberOfFishesAfterDaysEfficient(fishes, 80));
            System.out.println("Part 2: " + getNumberOfFishesAfterDaysEfficient(fishes, 256));
        }
    }

    private static long getNumberOfFishesAfterDaysEfficient(List<Integer> fishes, int days) {
